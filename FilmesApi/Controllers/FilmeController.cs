...
public class FilmeController : ControllerBase
{
    ...
    {
        skip = take * skip;
        var retorno = _mapper.Map<List<ReadFilmeDto>>(_context.Filmes.Skip(skip).Take(take));
        return Ok(retorno);
    }
    ...
    [HttpPatch("{id}")]
    public IActionResult AtualizarFilmeParcial([FromRoute] int id, JsonPatchDocument<UpdateFilmeDto> patch)
    {
        var filme = _context.Filmes.FirstOrDefault(x => x.Id == id);
